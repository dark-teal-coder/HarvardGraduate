---
title: "Challenge Problem: Lissajous Curves SOLUTIONS"
output:
...
x.vector <-
  sin( parameter.vector )

y.vector <-
  sin( 2 * parameter.vector )
...
x.vector <-
  sin( 3 * parameter.vector + pi/2 )

y.vector <-
  sin( 4 * parameter.vector )

lines(x.vector, y.vector)
```
