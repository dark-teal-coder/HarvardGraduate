---
title: "CSCI E-5a Spring 2022 Midterm Assessment Solutions"
output:
...
cat(
    "a coefficients:",
    formatC(
        x = head( coefficient.a.vector, n = 8 ),
        format = "f",
        digits = 2
    )
)
...
cat(
    "b coefficients:",
    formatC(
        x = head( coefficient.b.vector, n = 8 ),
        format = "f",
        digits = 2
    )
)
...
cat(
    "c coefficients:",
    formatC(
        x = head( coefficient.c.vector, n = 8 ),
        format = "f",
        digits = 2
    )
)
...
cat(
    "d coefficients:",
    formatC(
        x = head( coefficient.d.vector, n = 8 ),
        format = "f",
        digits = 2
    )
)
